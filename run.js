...
async function RaidInfo(RaidName) {
    ...
    switch (raidcode) {
        ...
        case 4:
            ...
            RaidEmbed.addField("더보기 보상 (장비 재료만)", "1-2 페이즈 (<:crystal:886884143198265345> 50) 뿔 7개 / 2 페이즈 (<:crystal:886884143198265345> 80) 뿔 7개 / 3 페이즈 (<:crystal:886884143198265345> 120) 뿔 8개 (총 뿔 22개)");
            ...
            RaidEmbed.addField("경매 보상 (장비 재료만)", "욕망의 날개 5개");
            RaidEmbed.addField("더보기 보상 (장비 재료만)", "1 페이즈 (<:crystal:886884143198265345> 100) 사념 7개 / 2 페이즈 (<:crystal:886884143198265345> 130) 사념 7개 / 3 페이즈 (<:crystal:886884143198265345> 200) 사념 8개 (총 사념 22개)");
            break;
        default:
            raidname = "오류";
            break;
